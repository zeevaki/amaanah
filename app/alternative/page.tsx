  ...
  return (
    <>
      <section style={{ padding: '8rem 1.5rem 5rem', maxWidth: '760px', margin: '0 auto', borderBottom: '1px solid #2a2420' }}>
        <p style={{ fontSize: '0.7rem', color: '#c8952a', letterSpacing: '0.25em', textTransform: 'uppercase', fontWeight: 600, marginBottom: '2rem' }}>Chapter Three</p>
      ...
      <article style={{ maxWidth: '760px', margin: '0 auto', padding: '4rem 1.5rem' }}>
        ...
        <section style={{ marginBottom: '4rem' }}>
          <p style={{ fontSize: '0.7rem', color: '#c8952a', letterSpacing: '0.2em', textTransform: 'uppercase', fontWeight: 600, marginBottom: '1rem' }}>The Supreme Court's Admission</p>
          ...
          <div className="pull-quote">The same country that drew redlining maps around Black neighborhoods, that watched two men die on Linfield Road in June 2026, officially acknowledges him as one of the world's greatest lawmakers. That is not a small thing.</div>
        </section>

        <section style={{ marginBottom: '4rem', background: '#131008', padding: '2.5rem', borderRadius: '2px', border: '1px solid #2a2420' }}>
          <p style={{ fontSize: '0.7rem', color: '#c8952a', letterSpacing: '0.2em', textTransform: 'uppercase', fontWeight: 600, marginBottom: '1rem' }}>The Constitution of Medina (622 CE)</p>
          <p style={{ fontSize: '1.1rem', lineHeight: 1.9, color: '#c0b8a8', marginBottom: '1.25rem' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: '#6a6050', letterSpacing: '0.05em', marginBottom: '0.75rem', fontWeight: 600, textTransform: 'uppercase' }}>Its principles:</p>
          {[
            ...
            'Wealth was a trust (Amaanah), not a possession. The Zakat system mandated redistribution within the same community that generated it.',
          ].map((point, i) => (
            <div key={i} style={{ display: 'flex', gap: '1rem', marginBottom: '0.75rem', alignItems: 'flex-start' }}>
              <span style={{ color: '#c8952a', fontWeight: 700, flexShrink: 0, marginTop: '0.15rem' }}>—</span>
              <p style={{ fontSize: '1rem', lineHeight: 1.8, color: '#a09880', margin: 0 }}>{point}</p>
            </div>
          ))}
        </section>

        <section style={{ marginBottom: '4rem' }}>
          <p style={{ fontSize: '0.7rem', color: '#c8952a', letterSpacing: '0.2em', textTransform: 'uppercase', fontWeight: 600, marginBottom: '1rem' }}>Emperor Akbar's System (1556–1605)</p>
          <p style={{ fontSize: '1.1rem', lineHeight: 1.9, color: '#c0b8a8', marginBottom: '1.25rem' }}>
          ...
          <div className="pull-quote">The tragedy of the 1947 Partition is that it forced the most deeply interwoven civilization on earth into two separate nation-states based on a single identity marker — religion — completely replacing the layered coexistence that Akbar's system had managed for 50 years.</div>
        </section>

        <section style={{ marginBottom: '4rem', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }} className="grid-mobile">
          <div style={{ border: '1px solid #2a2420', padding: '1.5rem', borderRadius: '2px' }}>
            <p style={{ fontSize: '0.7rem', color: '#c8952a', letterSpacing: '0.2em', textTransform: 'uppercase', fontWeight: 600, marginBottom: '0.75rem' }}>The Persian Model (550–330 BCE)</p>
            <p style={{ fontSize: '0.95rem', lineHeight: 1.8, color: '#8a8070' }}>Cyrus the Great divided his empire into provinces. The central government cared about three things: loyalty, taxes, military contribution. Beyond that — local languages, local laws, local worship. Cyrus famously allowed the exiled Jewish population to return to Jerusalem and rebuild their temple. Not because he converted. Because the system was designed to govern diversity, not erase it.</p>
          </div>
          <div style={{ border: '1px solid #2a2420', padding: '1.5rem', borderRadius: '2px' }}>
            <p style={{ fontSize: '0.7rem', color: '#c8952a', letterSpacing: '0.2em', textTransform: 'uppercase', fontWeight: 600, marginBottom: '0.75rem' }}>The Ottoman Millet System (1453–1922)</p>
            <p style={{ fontSize: '0.95rem', lineHeight: 1.8, color: '#8a8070' }}>The Ottomans organized people not by geography but by religious community — a millet. Greek Orthodox, Armenian Christians, and Jewish communities each had their own courts and family law. Distinct cultural, linguistic, and religious groups survived completely intact for over 400 years in the same cities without being forced to assimilate.</p>
          </div>
        </section>

        <section style={{ marginBottom: '5rem' }}>
          <p style={{ fontSize: '0.7rem', color: '#c8952a', letterSpacing: '0.2em', textTransform: 'uppercase', fontWeight: 600, marginBottom: '1rem' }}>What These Models Have in Common</p>
          <p style={{ fontSize: '1.1rem', lineHeight: 1.9, color: '#c0b8a8', marginBottom: '1.25rem' }}>
          ...
          <div className="pull-quote">The answer, in each case, was not forced assimilation. It was local autonomy within a shared framework of collective responsibility.</div>
          <p style={{ fontSize: '1.1rem', lineHeight: 1.9, color: '#c0b8a8' }}>
        ...
        <div style={{ borderTop: '1px solid #2a2420', paddingTop: '3rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <Link href="/freedom" style={{ fontSize: '0.8rem', color: '#4a4040', textDecoration: 'none', letterSpacing: '0.1em' }}>← Are We Truly Free?</Link>
          <Link href="/leadership" style={{ fontSize: '0.8rem', color: '#c8952a', textDecoration: 'none', letterSpacing: '0.1em', textTransform: 'uppercase', fontWeight: 600 }}>
            Continue Reading: New Leadership →
          </Link>
        </div>
      </article>

      <style>{`
        @media (max-width: 640px) { .grid-mobile { grid-template-columns: 1fr !important; } }
      `}</style>
    </>
  );
}
