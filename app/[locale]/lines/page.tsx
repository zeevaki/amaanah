      ...
      <article style={{ maxWidth: '760px', margin: '0 auto', padding: '4rem 1.5rem' }}>
        ...
        <section style={{ marginBottom: '4rem' }}>
          ...
          <div className="pull-quote">
            Because the violence on Linfield Road did not begin on Linfield Road.
          </div>
        </section>
          ...
          {[
            {
              ...
              body: 'Two diplomats — Mark Sykes of Britain and François Picot of France — sat with a map of the Middle East and drew straight lines across the desert using a ruler. They ignored centuries of tribal, religious, and ethnic realities. They forced rival groups into the same artificial countries and split unified communities in half. A century of Middle Eastern conflict traces directly to one afternoon with a ruler.',
            },
            {
              title: 'The Radcliffe Line (1947)',
              body: 'A British lawyer named Cyril Radcliffe — who had never visited India — was given five weeks to draw the border separating India and Pakistan. He used outdated maps and census data. He drew the line through villages, through fields, through houses. Fifteen million people fled. Over a million died. The rivalry between two nuclear-armed nations continues today because of five weeks of work by a man who had never been to the country he was dividing.',
            },
            {
              title: 'The Berlin Conference (1884–85)',
              body: 'Fourteen European powers gathered in Berlin to divide the African continent. Not one African leader was in the room. They drew geometric borders across 1,000 distinct cultures and kingdoms. The post-colonial civil conflicts that followed were not coincidental. They were designed.',
            },
          ].map((item) => (
            <div
              key={item.title}
            ...
            >
              <p style={{ fontFamily: "'Playfair Display', Georgia, serif", fontWeight: 700, color: '#e8c97e', marginBottom: '0.75rem', fontSize: '1.05rem' }}>
                {item.title}
              </p>
              <p style={{ fontSize: '1rem', lineHeight: 1.9, color: '#8a8a85' }}>
                {item.body}
              </p>
            </div>
          ))}
        ...
        <section style={{ marginBottom: '5rem' }}>
          ...
          <div className="pull-quote">
            These lines — from Linfield Road to the Radcliffe Line — share one thing: they were drawn by people who did not have to live with the consequences.
          </div>
        ...
        <div style={{ borderTop: '1px solid #1e1e1e', paddingTop: '3rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <Link href="/" style={{ fontSize: '0.8rem', color: '#4a4a45', textDecoration: 'none', letterSpacing: '0.1em' }}>← Home</Link>
          <Link
            href="/freedom"
            style={{
              fontSize: '0.8rem',
          ...
          >
            {t('nextChapter')}: Are We Truly Free? →
          </Link>
        </div>
      </article>
    </>
